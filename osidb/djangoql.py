...
class FlawNonCommunityAffectsNoTrackersField(BoolField):
    """Check if non-community affects are missing trackers."""

    model = Flaw
    name = "non_community_affects_missing_trackers"
    ...
    def get_lookup(self, path, operator, value):
        ...
        if operator == "=" or operator == "!=":
            ...
            # This filter is in place since has_non_community_affects_with_trackers doesn't
