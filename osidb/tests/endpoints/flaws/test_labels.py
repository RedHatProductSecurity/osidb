...
class TestLabelFiltering:
    ...
    def test_filter_flaws_with_any_label(self, auth_client, test_api_uri):
        """Test filtering to get flaws that have any labels"""
        # This test documents current behavior - filtering may need to be added
        response = auth_client().get(f"{test_api_uri}/flaws")

        assert response.status_code == status.HTTP_200_OK
        # All flaws should be returned
