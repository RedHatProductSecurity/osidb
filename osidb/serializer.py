...
class BaseSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data, *args, **kwargs):
        """
        exteded standard Django REST framework update method
        ...
        # https://github.com/encode/django-rest-framework/blob/master/rest_framework/serializers.py#L1018
...
# and the specifics are too complicated and fiting them
