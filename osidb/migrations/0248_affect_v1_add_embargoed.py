...
CREATE INDEX IF NOT EXISTS affect_v1_all_tracker_ids_gin_idx ON affect_v1 USING GIN (all_tracker_ids);
CREATE INDEX IF NOT EXISTS affect_v1_flaw_id_idx ON affect_v1 (flaw_id);
CREATE INDEX IF NOT EXISTS affect_v1_sorting_idx ON affect_v1 (created_dt, uuid);
"""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("osidb", "0247_replace_acl_annotations_with_generated_fields"),
    ]
