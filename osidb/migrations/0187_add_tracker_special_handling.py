# Generated by Django 4.2.17 on 2025-03-04 21:41
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('osidb', '0186_add_tracker_resolved_dt'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=django.contrib.postgres.fields.ArrayField(base_field=models.CharField(choices=[('Major Incident', 'Major Incident'), ('KEV (active exploit case)', 'Kev'), ('compliance-priority', 'Compliance Priority'), ('contract-priority', 'Contract Priority')], max_length=100), blank=True, default=list, size=None),
        ),
        migrations.AddField(
