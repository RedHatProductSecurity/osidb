...
class ProductFamilyLabel(FlawLabelV2):
    ...
    def create_from_affect(affect):
        ...
        """
        existing = set(affect.flaw.labels_v2.values_list("name", flat=True))
    ...
    def update_relevance(flaw):
        ...
        # Check all label types to avoid IntegrityError on unique constraint
        existing_names = set(flaw.labels_v2.values_list("name", flat=True))
