"""
Polymorphic label models.

Each label type inherits from FlawLabel and gets its own table
with type-specific fields. The polymorphic_ctype column auto-tracks
which subclass each row belongs to.
"""
...
# Public alias — the rest of the codebase imports FlawLabel.
# The Django model class stays FlawLabelV2 until the polymorphic
# RenameModel migration issue is resolved separately.
FlawLabel = FlawLabelV2

FlawLabelV2.TYPE_TO_MODEL = {
    FlawLabelV2.LabelType.ALIAS: AliasLabel,
    FlawLabelV2.LabelType.BU: BULabel,
    FlawLabelV2.LabelType.CONTEXT_BASED: CollaboratorLabel,
    FlawLabelV2.LabelType.PRODUCT_FAMILY: ProductFamilyLabel,
    FlawLabelV2.LabelType.WORKFLOW: WorkflowLabel,
}
