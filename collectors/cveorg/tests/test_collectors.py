...
class TestCVEorgCollector:
    @pytest.mark.vcr
    def test_collect_cveorg_records(self, mock_repo, mock_keywords):
        """
    ...
    def test_collect_cveorg_record_when_flaw_exists(self, mock_repo, mock_keywords):
        """
    ...
    def test_ignored_cveorg_records(self, mock_repo, mock_keywords):
        """
...
class TestCVEorgCollectorException:
    ...
    def test_atomicity(self, monkeypatch, mock_repo, mock_keywords):
        """
