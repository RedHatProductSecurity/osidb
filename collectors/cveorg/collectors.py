...
class CVEorgCollector(Collector):
    ...
    def _process_file_content(self, file_path: str) -> tuple[str | None, str | None]:
        """
    ...
    def collect_cve(self, cve: str) -> str:
        ...
        try:
            _, new_flaw = self._process_file_content(file_path)
            return (
    ...
    def collect(self) -> str:
        ...
        for file_path in file_paths:
            try:
                new_snippet, new_flaw = self._process_file_content(file_path)
                if new_snippet:
