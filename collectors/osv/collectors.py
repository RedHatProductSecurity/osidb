...
class OSVCollector(Collector):
    ...
    def extract_content(self, osv_vuln: dict) -> tuple[str, list, dict]:
        ...
        # Not used, might be useful in the future (OSIDB-4954)
        ...
        content = {
            ...
            # Additional upstream data that we might extract later
            # "upstream_descriptions": [comment_zero] if comment_zero else [], (OSIDB-4953)
            # "upstream_severities": get_upstream_severities(osv_vuln), (OSIDB-4954)
        }
