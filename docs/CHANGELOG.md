...
## Unreleased
### Changed
- Add SRP payload field schema metadata for CRA milestone dialogs (OSIDB-5604)
...
- Certain workflow labels now provide a `reason` attribute which can provide
  insights as to why it was applied (OSIDB-5346)
...
## [5.16.2] - 2026-08-13
### Fixed
- fix the Celery worker and queuing issues

## [5.16.1] - 2026-08-12
### Fixed
- Migration 0262 no longer gets stuck in a deadlock
...
- check workflow labels only in worklow label check (OSIDB-5275)
...
### Fixed
- fix DjangoQL label migration (OSIDB-5303)
- Fixed an issue that yielded 500 errors in certain scenarios (OSIDB-5302, OSIDB-5304)
...
- Enable RLS on AclMixin child tables (OSIDB-5129)
...
- Fix returning 500 error on comment creation / sync to BZ (OSIDB-4634)
