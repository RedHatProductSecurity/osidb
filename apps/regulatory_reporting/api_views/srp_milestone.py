...
class SRPReportMilestoneViewSet(RegulatoryReportingEnabledMixin, ModelViewSet):
    """
...
class AdditionalInformationRequestViewSet(
    ...
    -GET /regulatory-reporting/api/v1/srp-reports/{report_uuid}/milestones/{milestone_uuid}/additional-information-requests/{uuid}
    -POST /regulatory-reporting/api/v1/srp-reports/{report_uuid}/milestones/{milestone_uuid}/additional-information-requests/{uuid}
