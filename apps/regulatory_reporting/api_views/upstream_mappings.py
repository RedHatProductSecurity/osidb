...
from apps.regulatory_reporting.models.upstream import FlawUpstreamMapping
from apps.regulatory_reporting.serializers.upstream import FlawUpstreamMappingSerializer
